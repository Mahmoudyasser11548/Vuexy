    ...
    builder
      ...
      .addMatcher(
        isAnyOf(
          ...
          addGuest.pending,
          deleteGuest.pending,
          editGuestReward.pending
        ),
        (state) => {
          state.guest_loading = true
        }
      )
      ...
      .addMatcher(
        isAnyOf(
          ...
          editGuestReward.fulfilled
        ),
        (state) => {
          state.guest_loading = false
        }
      )
      ...
      .addMatcher(
        isAnyOf(
          getGuests.rejected,
          addGuest.rejected,
          deleteGuest.rejected,
          editGuestReward.rejected
        ),
        (state, action) => {
          state.guest_loading = false
          state.guest_error = action.error.message
        }
      )
  }
})
